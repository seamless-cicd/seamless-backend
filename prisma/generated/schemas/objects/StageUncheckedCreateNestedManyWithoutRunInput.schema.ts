...
const Schema: z.ZodType<Prisma.StageUncheckedCreateNestedManyWithoutRunInput> =
  z
    .object({
      create: z
        .union([
...
export const StageUncheckedCreateNestedManyWithoutRunInputObjectSchema = Schema;
