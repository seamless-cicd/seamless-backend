...
const Schema: z.ZodType<Prisma.RunUpdateManyWithoutServiceNestedInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => RunUncheckedCreateWithoutServiceInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => RunCreateOrConnectWithoutServiceInputObjectSchema),
        z.lazy(() => RunCreateOrConnectWithoutServiceInputObjectSchema).array(),
      ])
      .optional(),
    upsert: z
      .union([
...
export const RunUpdateManyWithoutServiceNestedInputObjectSchema = Schema;
