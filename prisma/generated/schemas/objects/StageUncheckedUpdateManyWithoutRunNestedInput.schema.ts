...
const Schema: z.ZodType<Prisma.StageUncheckedUpdateManyWithoutRunNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const StageUncheckedUpdateManyWithoutRunNestedInputObjectSchema = Schema;
