...
import { RunUpdateOneWithoutStagesNestedInputObjectSchema } from './RunUpdateOneWithoutStagesNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.StageUpdateInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    status: z
      ...
      .optional(),
    Run: z
      .lazy(() => RunUpdateOneWithoutStagesNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const StageUpdateInputObjectSchema = Schema;
