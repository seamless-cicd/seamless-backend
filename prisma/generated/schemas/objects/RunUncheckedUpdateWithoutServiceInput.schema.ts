...
import { StageUncheckedUpdateManyWithoutRunNestedInputObjectSchema } from './StageUncheckedUpdateManyWithoutRunNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.RunUncheckedUpdateWithoutServiceInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    triggerType: z
      ...
      .optional(),
    stages: z
      .lazy(() => StageUncheckedUpdateManyWithoutRunNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const RunUncheckedUpdateWithoutServiceInputObjectSchema = Schema;
