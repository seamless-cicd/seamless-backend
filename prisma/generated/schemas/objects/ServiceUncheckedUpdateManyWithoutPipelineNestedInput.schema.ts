...
const Schema: z.ZodType<Prisma.ServiceUncheckedUpdateManyWithoutPipelineNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ServiceUncheckedUpdateManyWithoutPipelineNestedInputObjectSchema =
  Schema;
