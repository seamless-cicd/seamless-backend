...
const Schema: z.ZodType<Prisma.ServiceUncheckedCreateNestedManyWithoutPipelineInput> =
  z
    .object({
      create: z
        .union([
...
export const ServiceUncheckedCreateNestedManyWithoutPipelineInputObjectSchema =
  Schema;
